...
<template>
  <div class="parentx">
    ...
    <vs-sidebar class="v-nav-menu items-no-padding"
      ...
      <div @mouseenter="mouseEnter"
        ...
        <!-- Header -->
        <div class="header-sidebar flex items-end justify-between"
             slot="header">
        ...
        <component :is="scrollbarTag"
          ...
          <template v-for="(item, index) in menuItemsUpdated">
            ...
            <!-- Group Header -->
            <span v-if="item.header && !verticalNavMenuItemsMin"
            ...
            <template v-else-if="!item.header">
              ...
              <!-- Nav-Item -->
              <v-nav-menu-item v-if="!item.submenu"
                               :key="`item-${index}`"
                               :index="index"
              ...
              <!-- Nav-Group -->
              <template v-else>
                <v-nav-menu-group :key="`group-${index}`"
