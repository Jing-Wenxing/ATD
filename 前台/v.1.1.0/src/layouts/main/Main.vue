...
<template>
  <div class="layout--main"
    ...
    <v-nav-menu :navMenuItems="navMenuItems"
                title="ATD"
                parent=".layout--main" />
    ...
    <div id="content-area"
      ...
      <template v-if="mainLayoutType === 'horizontal' && windowWidth >= 1200">
        <the-navbar-horizontal :navbarType="navbarType"
                               :class="[
      ...
      <template v-else>
        <the-navbar-vertical :navbarColor="navbarColor"
                             :class="[
          {'text-white' : isNavbarDark  && !isThemeDark},
          {'text-base'  : !isNavbarDark && isThemeDark}
        ]" />
          ...
          <div class="router-content">
            ...
            <transition :name="routerTransition">
              ...
              <div v-if="$route.meta.breadcrumb || $route.meta.pageTitle"
                ...
                <!-- BREADCRUMB -->
                <vx-breadcrumb class="ml-4 md:block hidden"
