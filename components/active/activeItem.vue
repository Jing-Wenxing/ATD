    ...
    <div class="center">
      <div class="left">
        ...
        <div class="option margin-top">
          <div v-if="start == 0">
            <button class="yuyue" @click="isYuyue()">预约参加</button>
          </div>
          <button v-if="start == 1" class="ing" disabled>活动进行中</button>
          <button v-if="start == 2" class="end" disabled>活动结束</button>
        </div>
      </div>
      <div class="right">
